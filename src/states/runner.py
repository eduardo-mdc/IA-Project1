...
class Runner(GameState):
    ...
    # dps cria se a estrutura do state
    def fall_r(fallen, orientation, x, y, maze):
        if (fallen == False and orientation == None and
        ((maze[x+1, y][y] == 1 and maze[x+2, y][y] == 1) or
        (maze[x+1, y][y] == 1 and maze[x+2, y][y] == 2) or
        (maze[x+1, y][y] == 2 and maze[x+2, y][y] == 1))):
            return x # return fallen = true, orientation = horizontal, x += 1.5 e y
        
    def fall_l(fallen, orientation, x, y, maze):
        if (fallen == False and orientation == None and
        ((maze[x-1, y][y] == 1 and maze[x-2, y][y] == 1) or
        (maze[x-1, y][y] == 1 and maze[x-2, y][y] == 2) or
        (maze[x-1, y][y] == 2 and maze[x-2, y][y] == 1))):
    ...
    def fall_u(fallen, orientation, x, y, maze):
        if (fallen == False and orientation == None and
        ((maze[x, y-1][y] == 1 and maze[x, y-2][y] == 1) or
        (maze[x, y-1][y] == 1 and maze[x, y-2][y] == 2) or
        (maze[x, y-1][y] == 2 and maze[x, y-2][y] == 1))):
            return x # return fallen = true, orientation = horizontal, x e y-=1.5
    ...
    def get_up_r(fallen, orientation, x, y, maze):
        if(fallen == True and orientation == "horizontal" and maze[x+1.5][y] == 1):
            return x # return fallen = false, orientation = None, x+=1.5 e y
        
    def get_up_l(fallen, orientation, x, y, maze):
        if(fallen == True and orientation == "horizontal" and maze[x-1.5][y] == 1):
            return x # return fallen = false, orientation = None, x-=1.5 e y
        
    def get_up_u(fallen, orientation, x, y, maze):
        if(fallen == True and orientation == "vertical" and maze[x][y-1.5] == 1):
            return x # return fallen = false, orientation = None, x e y-=1.5

    def get_up_d(fallen, orientation, x, y, maze):
        if(fallen == True and orientation == "vertical" and maze[x][y+1.5] == 1):
            return x # return fallen = false, orientation = None, x e y+=1.5
        
    def roll_r(fallen, orientation, x, y, maze):
        if (fallen == True and orientation == "vertical" and
        ((maze[x+1][y-0.5] == 1 and maze[x+1][y+0.5] == 1) and
        (maze[x+1][y-0.5] == 1 and maze[x+1][y+0.5] == 2) and
        (maze[x+1][y-0.5] == 2 and maze[x+1][y+0.5] == 1))):
            return x # return fallen = True, orientation = horizontal, x+=1 e y
        
    def roll_l(fallen, orientation, x, y, maze):
        if (fallen == True and orientation == "vertical" and
        ((maze[x-1][y-0.5] == 1 and maze[x-1][y+0.5] == 1) and
        (maze[x-1][y-0.5] == 1 and maze[x-1][y+0.5] == 2) and
        (maze[x-1][y-0.5] == 2 and maze[x-1][y+0.5] == 1))):
    ...
    def roll_u(fallen, orientation, x, y, maze):
        if (fallen == True and orientation == "horizontal" and
        ((maze[x-0.5][y-1] == 1 and maze[x+0.5][y-1] == 1) and
        (maze[x-0.5][y-1] == 1 and maze[x+0.5][y-1] == 2) and
        (maze[x-0.5][y-1] == 2 and maze[x+0.5][y-1] == 1))):
            return x # return fallen = True, orientation = horizontal, x e y-=1
        
    def roll_d(fallen, orientation, x, y, maze):
        if (fallen == True and orientation == "horizontal" and
        ((maze[x-0.5][y+1] == 1 and maze[x+0.5][y+1] == 1) and
        (maze[x-0.5][y+1] == 1 and maze[x+0.5][y+1] == 2) and
        (maze[x-0.5][y+1] == 2 and maze[x+0.5][y+1] == 1))):
            return x # return fallen = True, orientation = horizontal, x+=1 e y+=1